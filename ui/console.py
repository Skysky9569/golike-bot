...
def menu() -> None:
    ...
    print(colored("════════════════════════════════════════════════", "white"))
    print(colored("⚡ CHỨC NĂNG CHÍNH:", "yellow", bold=True))
    print(colored("   [1] 🥇 Vào Tool TikTok (Auto ADB)", "cyan"))
    print(colored("   [2] 📱 Vào Tool Facebook (API Chạy Ngầm - Tốc độ)", "white"))
    print(colored("   [3] 🔥 Vào Tool Facebook (Selenium - An Toàn/DOM)", "white"))
    print(colored("   [7] 🍏 Vào Tool TikTok (iOS - Appium)", "magenta"))
    print(colored("   [9] 🛠️  Quick FB Interaction (DOM Tool)", "yellow"))
